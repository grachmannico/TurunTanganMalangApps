...
public class ProfilDonaturActivity extends AppCompatActivity {
...
//    IMAGE CROPPER
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profil_donatur);
        ...
        img_foto_profil_donatur = (ImageView) findViewById(R.id.img_foto_profil_donatur);
        edt_nama_donatur = (EditText) findViewById(R.id.edt_nama_donatur);
        edt_pass_donatur = (EditText) findViewById(R.id.edt_pass_donatur);
        ...
        btn_edit_profil_donatur = (Button) findViewById(R.id.btn_edit_profil_donatur);
        ...
        btn_edit_profil_donatur.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                show_edit.setVisibility(View.VISIBLE);
                btn_update_foto_profil.setVisibility(View.VISIBLE);
                btn_edit_profil_donatur.setVisibility(View.GONE);
//                edt_nama_donatur.setEnabled(true);
                edt_nama_donatur.setClickable(true);
                edt_nama_donatur.setCursorVisible(true);
                edt_nama_donatur.setFocusable(true);
                edt_nama_donatur.setFocusableInTouchMode(true);
            }
        });
        ...
        btn_batal_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                btn_edit_profil_donatur.setVisibility(View.VISIBLE);
//                edt_nama_donatur.setEnabled(false);
                edt_nama_donatur.setClickable(false);
                edt_nama_donatur.setCursorVisible(false);
                edt_nama_donatur.setFocusable(false);
                edt_nama_donatur.setFocusableInTouchMode(false);
            }
        });
        ...
        btn_update_profil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                password = edt_pass_donatur.getText().toString();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(ProfilDonaturActivity.this, MainActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE && resultCode == Activity.RESULT_OK){
            ...
            img_foto_profil_donatur.setImageURI(croppedImage);
        }
    }
    ...
    class Profil extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(ProfilDonaturActivity.this);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (status.equals("sukses")) {
                ...
                edt_nama_donatur.setText(nama);
                edt_pass_donatur.setText(password);
    ...
    class Update_Profil extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (status.equals("sukses")) {
                ...
                Intent intent = new Intent(ProfilDonaturActivity.this, ProfilDonaturActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(intent);
                finish();
